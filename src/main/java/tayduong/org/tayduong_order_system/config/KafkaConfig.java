...
public class KafkaConfig {
    ...
    public NewTopic orderStatusChangedTopic() {
        return new NewTopic(KafkaTopics.ORDER_STATUS_CHANGED, 3, (short) 1);
    }

    @Bean
    public NewTopic orderUpdatedTopic() {
        return new NewTopic(KafkaTopics.ORDER_UPDATED, 3, (short) 1);
    }

    @Bean
    public NewTopic notificationTopic() {
        return new NewTopic(KafkaTopics.NOTIFICATION, 3, (short) 1);
    }
}
